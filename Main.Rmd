...
| Población| Tamaño| Promedio| Varianza|
|:--|:--|:--|:--|
| Diamantes| `r n1`| `r mu1`| `r var1`|
...
De los resultados obtenidos, se puede concluir que como la media de precios del dataset de diamantes `r mean(as.data.frame(diamantes)$precio)` se encuentra en el intervalo ]`r IC`[, todo está correcto.
