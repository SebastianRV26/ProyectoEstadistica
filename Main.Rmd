...
y la población 1 y la población 2 siguen una distribución normal
...
```
En conclusión con los datos obtenidos podemos decir que...
...
```
En conclusión al resultado obtenido podemos ver que las varianzas de estas dos poblaciones no pueden ser iguales ya que el numero 1 no pertenece al intervalo que obtenemos, en este caso la varianza de la población 1 es mayor a la de la población 2 ya que el intervalo es positivo.
